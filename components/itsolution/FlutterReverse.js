...
const ReactNative = ({title,paragraph,img}) => {
  ...
  return (
    <>
        <div className='w-[100%]  white text-black p-20 max-sm:p-5'>
            <div className='w-[90%] mx-auto flex flex-row-reverse justify-between items-center max-sm:w-[100%] max-sm:flex max-sm:flex-col'>
